...
class ScopeTable 
{
    ...
    private:
        ...
        void setId() 
        {
            ...
            this->scopeId = parentScope->scopeId + "_" + to_string(++(parentScope->childNumber));
        }
        ...
        void setHashFunc(int hashFunction = 0)
        {
            if (hashFunction == 0)
            {
                hashFunc = &SBDM_HASH;
    ...
    public:
        ...
        ull scopeNumber;
        string scopeId;
        ull childNumber; // used to create uniquely identifiable child scopes
        ...
        void printScopeTable(int tabCount);
...
void ScopeTable::printScopeTable(int tabCount = 1)
{
    ...
    cout << "ScopeTable# " << this->scopeNumber << endl;
