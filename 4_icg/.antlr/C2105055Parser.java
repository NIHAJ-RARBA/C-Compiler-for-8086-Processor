// Generated from e://CODE//C++//cpp_Works//compiler//4_icg//C2105055Parser.g4 by ANTLR 4.13.1
...
public class C2105055Parser extends Parser {
	...
	public static final int
		...
		CASE=8, DEFAULT=9, BREAK=10, CONTINUE=11, FOR=12, WHILE=13, DO=14, PRINTLN=15, 
		PRINTF=16, RETURN=17, INT=18, FLOAT=19, VOID=20, STRUCT=21, LPAREN=22, 
		RPAREN=23, LCURL=24, RCURL=25, LTHIRD=26, RTHIRD=27, SEMICOLON=28, COMMA=29, 
		COLON=30, ADDOP=31, SUBOP=32, MULOP=33, INCOP=34, DECOP=35, NOT=36, RELOP=37, 
		LOGICOP=38, ASSIGNOP=39, ID=40, CONST_INT=41, CONST_FLOAT=42, UNRECOGNIZED_CHAR=43;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'default'", "'break'", "'continue'", "'for'", "'while'", "'do'", "'println'", 
			"'printf'", "'return'", "'int'", "'float'", "'void'", "'struct'", "'('", 
			"')'", "'{'", "'}'", "'['", "']'", "';'", "','", "':'", null, null, null, 
			"'++'", "'--'", "'!'", null, null, "'='"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PRINTLN", "PRINTF", "RETURN", "INT", "FLOAT", "VOID", "STRUCT", "LPAREN", 
			"RPAREN", "LCURL", "RCURL", "LTHIRD", "RTHIRD", "SEMICOLON", "COMMA", 
			"COLON", "ADDOP", "SUBOP", "MULOP", "INCOP", "DECOP", "NOT", "RELOP", 
			"LOGICOP", "ASSIGNOP", "ID", "CONST_INT", "CONST_FLOAT", "UNRECOGNIZED_CHAR"
		};
	}
	...
	public static class STATEMENT_PRINTLNContext extends StatementContext {
		...
		public Token ID;
		public Token RPAREN;
		public TerminalNode PRINTLN() { return getToken(C2105055Parser.PRINTLN, 0); }
		public TerminalNode LPAREN() { return getToken(C2105055Parser.LPAREN, 0); }
		public TerminalNode ID() { return getToken(C2105055Parser.ID, 0); }
		public TerminalNode RPAREN() { return getToken(C2105055Parser.RPAREN, 0); }
		public TerminalNode SEMICOLON() { return getToken(C2105055Parser.SEMICOLON, 0); }
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				{
				setState(339);
				((STATEMENT_PRINTLNContext)_localctx).PRINTLN = match(PRINTLN);
				setState(340);
				...
				match(SEMICOLON);
				            ...
				            ((STATEMENT_PRINTLNContext)_localctx).stmtStr =  ((STATEMENT_PRINTLNContext)_localctx).PRINTLN->getText() + " " + ((STATEMENT_PRINTLNContext)_localctx).LPAREN->getText() + ((STATEMENT_PRINTLNContext)_localctx).ID->getText() + ((STATEMENT_PRINTLNContext)_localctx).RPAREN->getText() + ";";
